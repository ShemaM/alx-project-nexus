...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero Section */}
      <section className="bg-[#0F4C81] py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-6">
            Empowering Refugee Youth Through <span className="text-[#F5A623]">Opportunities</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-[#0F4C81]">Our Mission</h2>
              </div>
            ...
            <div className="bg-gradient-to-br from-[#0F4C81]/5 to-[#F5A623]/5 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-[#0F4C81]/10 rounded-xl flex items-center justify-center">
                  <Users className="w-6 h-6 text-[#0F4C81]" />
                </div>
                <h2 className="text-2xl font-bold text-[#0F4C81]">Who We Serve</h2>
              </div>
              <ul className="space-y-4 text-slate-600">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#F5A623] rounded-full mt-2 flex-shrink-0"></span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-4xl md:text-5xl font-extrabold text-[#F5A623] mb-2">
                  {stat.value}
                </div>
